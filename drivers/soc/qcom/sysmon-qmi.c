...
//#if defined(FEATURE_LGE_MBSP_SYSMON_IF_ENABLE)
        [LGE_MODEM_MODE_LPM] = LGE_SSCTL_SSR_EVENT_MODE_LPM,
        [LGE_MODEM_MODE_ONLINE] = LGE_SSCTL_SSR_EVENT_MODE_ONLINE,
        [LGE_MODEM_DEBUGGER_TIME_TAG] = LGE_SSCTL_SSR_EVENT_MODEM_DEBUGGER_TIME_TAG,
        [LGE_MODEM_DEBUGGER_ENABLE] = LGE_SSCTL_SSR_EVENT_MODEM_DEBUGGER_ENABLE,
        [LGE_MODEM_DEBUGGER_DISABLE] = LGE_SSCTL_SSR_EVENT_MODEM_DEBUGGER_DISABLE,
